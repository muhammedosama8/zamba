...
const Footer: React.FC = () => {
  ...
  const columns = [
    { title: f.quickLinks, labels: f.links.quickLinks, hrefs: footerHrefs.quickLinks },
        ...
        <div className={styles.top}>
          <div className={styles.brand}>
            ...
            <div className={styles.socials}>
              ...
              <a href="#" className={styles.social} aria-label="YouTube"><YouTubeIcon /></a>
            </div>
          </div>
            ...
            <div key={col.title} className={styles.column}>
              ...
              <ul className={styles.columnLinks}>
                {col.labels.map((label, i) => (
                  <li key={i}>
                    <Link to={col.hrefs[i]} className={styles.columnLink}>{label}</Link>
                  </li>
                ))}
              </ul>
            </div>
